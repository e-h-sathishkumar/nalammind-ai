...
export default function NalamMindSection() {
  ...
  return (
    <main>
      {/* Navigation Links */}
      <div className="hidden md:flex gap-6 font-medium p-4 justify-center bg-white shadow-sm items-center">
        ...
        <a href="#who-we-serve" className="hover:text-blue-700">Who We Serve</a>
      ...
      {/* What We Believe */}
      <div className="max-w-6xl mx-auto px-6 mb-16">
        <div className="bg-gray-50 p-10 rounded-2xl text-center shadow-sm">
          <h3 className="text-3xl font-bold text-blue-900 mb-6">What We Believe</h3>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-3xl mx-auto">
            ...
            <a
              ...
              className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-lg font-semibold inline-block transition"
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-4 mt-10">
            <div className="bg-white p-5 rounded-lg shadow">
              <h3 className="font-bold text-blue-900 mb-2">Self-Awareness</h3>
              <p className="text-sm text-gray-600">Understanding emotions, triggers, and parenting patterns.</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow">
              <h3 className="font-bold text-blue-900 mb-2">Emotional Regulation</h3>
              <p className="text-sm text-gray-600">Managing stress, anxiety, and everyday parenting challenges.</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow">
              <h3 className="font-bold text-blue-900 mb-2">Parent-Child Connection</h3>
              <p className="text-sm text-gray-600">Building trust, communication, and meaningful relationships.</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow">
              <h3 className="font-bold text-blue-900 mb-2">Positive Growth</h3>
              <p className="text-sm text-gray-600">Creating a supportive and emotionally healthy family culture.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl shadow text-left">
              ...
              <h4 className="font-bold text-blue-900">— Parent Participant</h4>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow text-left">
              ...
              <h4 className="font-bold text-blue-900">— School Counselor</h4>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow text-left">
              ...
              <h4 className="font-bold text-blue-900">— School Principal</h4>
            </div>
          </div>
        </div> 
      </section>
      ...
      <section id="who-we-serve" className="py-20 bg-gray-50 scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-4">Who We Serve</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left">
              ...
              <h3 className="text-2xl font-bold text-blue-900 mb-3">Parents</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left">
              <div className="text-5xl mb-4">🎓</div>
              <h3 className="text-2xl font-bold text-blue-900 mb-3">Students</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left">
              <div className="text-5xl mb-4">👩‍🏫</div>
              <h3 className="text-2xl font-bold text-blue-900 mb-3">Educators</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left">
              <div className="text-5xl mb-4">🏫</div>
              <h3 className="text-2xl font-bold text-blue-900 mb-3">Schools</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-blue-900 mb-6">How We Use AI</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-8 rounded-2xl shadow-lg">
              <div className="text-4xl mb-4">🧠</div>
              <h3 className="text-xl font-bold text-blue-900 mb-3">Personalized Insights</h3>
            ...
            <div className="bg-green-50 p-8 rounded-2xl shadow-lg">
              <div className="text-4xl mb-4">📚</div>
              <h3 className="text-xl font-bold text-blue-900 mb-3">Resource Discovery</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-purple-50 p-8 rounded-2xl shadow-lg">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold text-blue-900 mb-3">Human-Centred Support</h3>
              <p className="text-gray-700">
      ...
      <section id="contact" className="scroll-mt-20 py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-blue-900 text-center mb-6">Contact Us</h2>
      ...
      <section className="bg-blue-900 text-white py-16 px-6 text-center">
        <h2 className="text-3xl font-bold mb-4">Begin Your Wellbeing Journey Today</h2>
        <p className="mb-6">
          Explore our wellbeing programs for parents, students, educators, and schools.
        </p>
        <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full shadow-2xl font-semibold z-50 transition-all duration-300 hover:scale-110 flex items-center gap-2"
      >
        💬 WhatsApp
      </a>
    </main>
